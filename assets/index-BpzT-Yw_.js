 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const d5="FirebaseError";class Gs extends Error{constructor(e,n,r){super(n),this.code=e,this.customData=r,this.name=d5,Object.setPrototypeOf(this,Gs.prototype),Error.captureStackTrace&&Error.captureStackTrace(this,LE.prototype.create)}}class LE{constructor(e,n,r){this.service=e,this.serviceName=n,this.errors=r}create(e,...n){const r=n[0]||{},i=`${this.service}/${e}`,o=this.errors[e],s=o?f5(o,r):"Error",a=`${this.serviceName}: ${s} (${i}).`;return new Gs(i,a,r)}}function f5(t,e){return t.replace(p5,(n,r)=>{const i=e[r];return i!=null?String(i):`<${r}?>`})}const p5=/\{\$([^}]+)}/g;function Xp(t,e){if(t===e)return!0;const n=Object.keys(t),r=Object.keys(e);for(const i of n){if(!r.includes(i))return!1;const o=t[i],s=e[i];if(c1(o)&&c1(s)){if(!Xp(o,s))return!1}else if(o!==s)return!1}for(const i of r)if(!n.includes(i))return!1;return!0}function c1(t){return t!==null&&typeof t=="object"}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function x1(t){let e=0;for(const n in t)Object.prototype.hasOwnProperty.call(t,n)&&e++;return e}function Xs(t,e){for(const n in t)Object.prototype.hasOwnProperty.call(t,n)&&e(n,t[n])}function JE(t){for(const e in t)if(Object.prototype.hasOwnProperty.call(t,e))return!1;return!0}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const s4=new Ze(oe.comparator);function Hr(){return s4}const uT=new Ze(oe.comparator);function Fa(...t){let e=uT;for(const n of t)e=e.insert(n.key,n);return e}function cT(t){let e=uT;return t.forEach((n,r)=>e=e.insert(n,r.overlayedDocument)),e}function ho(){return rl()}function hT(){return rl()}function rl(){return new Ys(t=>t.toString(),(t,e)=>t.isEqual(e))}const a4=new Ze(oe.comparator),l4=new It(oe.comparator);function ve(...t){let e=l4;for(const n of t)e=e.add(n);return e}const u4=new It(ke);function c4(){return u4}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class K4{constructor(){this.changes=new Ys(e=>e.toString(),(e,n)=>e.isEqual(n)),this.changesApplied=!1}addEntry(e){this.assertNotApplied(),this.changes.set(e.key,e)}removeEntry(e,n){this.assertNotApplied(),this.changes.set(e,Ht.newInvalidDocument(e).setReadTime(n))}getEntry(e,n){this.assertNotApplied();const r=this.changes.get(n);return r!==void 0?q.resolve(r):this.getFromCache(e,n)}getEntries(e,n){return this.getAllFromCache(e,n)}apply(e){return this.assertNotApplied(),this.changesApplied=!0,this.applyChanges(e)}assertNotApplied(){}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class sN{constructor(){this.Gi=!1,this.zi=!1,this.ji=100,this.Hi=function(){return u5()?8:FD(a5())>0?6:4}()}initialize(e,n){this.Ji=e,this.indexManager=n,this.Gi=!0}getDocumentsMatchingQuery(e,n,r,i){const o={result:null};return this.Yi(e,n).next(s=>{o.result=s}).next(()=>{if(!o.result)return this.Zi(e,n,i,r).next(s=>{o.result=s})}).next(()=>{if(o.result)return;const s=new oN;return this.Xi(e,n,s).next(a=>{if(o.result=a,this.zi)return this.es(e,n,s,a.size)})}).next(()=>o.result)}es(e,n,r,i){return r.documentReadCount<this.ji?(ka()<=Te.DEBUG&&J("QueryEngine","SDK will not create cache indexes for query:",Qo(n),"since it only creates cache indexes for collection contains","more than or equal to",this.ji,"documents"),q.resolve()):(ka()<=Te.DEBUG&&J("QueryEngine","Query:",Qo(n),"scans",r.documentReadCount,"local documents and returns",i,"documents as results."),r.documentReadCount>this.Hi*i?(ka()<=Te.DEBUG&&J("QueryEngine","The SDK decides to create cache indexes for query:",Qo(n),"as using cache indexes may help improve performance."),this.indexManager.createTargetIndexes(e,hr(n))):q.resolve())}Yi(e,n){if(R1(n))return q.resolve(null);let r=hr(n);return this.indexManager.getIndexType(e,r).next(i=>i===0?null:(n.limit!==null&&i===1&&(n=am(n,null,"F"),r=hr(n)),this.indexManager.getDocumentsMatchingTarget(e,r).next(o=>{const s=ve(...o);return this.Ji.getDocuments(e,s).next(a=>this.indexManager.getMinOffset(e,r).next(l=>{const c=this.ts(n,a);return this.ns(n,c,s,l.readTime)?this.Yi(e,am(n,null,"F")):this.rs(e,c,n,l)}))})))}Zi(e,n,r,i){return R1(n)||i.isEqual(ce.min())?q.resolve(null):this.Ji.getDocuments(e,r).next(o=>{const s=this.ts(n,o);return this.ns(n,s,r,i)?q.resolve(null):(ka()<=Te.DEBUG&&J("QueryEngine","Re-using previous result from %s to execute query: %s",i.toString(),Qo(n)),this.rs(e,s,n,OD(i,-1)).next(a=>a))})}ts(e,n){let r=new It(lT(e));return n.forEach((i,o)=>{pd(e,o)&&(r=r.add(o))}),r}ns(e,n,r,i){if(e.limit===null)return!1;if(r.size!==n.size)return!0;const o=e.limitType==="F"?n.last():n.first();return!!o&&(o.hasPendingWrites||o.version.compareTo(i)>0)}Xi(e,n,r){return ka()<=Te.DEBUG&&J("QueryEngine","Using full collection scan to execute query:",Qo(n)),this.Ji.getDocumentsMatchingQuery(e,n,Pi.min(),r)}rs(e,n,r,i){return this.Ji.getDocumentsMatchingQuery(e,r,i).next(o=>(n.forEach(s=>{o=o.insert(s.key,s)}),o))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function SO(t){t=zs(t,Nn);const e=zs(t.firestore,Ed);return sO(my(e),t._key).then(n=>kO(e,t,n))}class pS extends xO{constructor(e){super(),this.firestore=e}convertBytes(e){return new Us(e)}convertReference(e){const n=this.convertDocumentKey(e,this.firestore._databaseId);return new Nn(this.firestore,null,n)}}function Oo(t){t=zs(t,_d);const e=zs(t.firestore,Ed),n=my(e),r=new pS(e);return bO(t._query),aO(n,t._query).then(i=>new EO(e,r,t,i))}function PO(t,e){const n=zs(t.firestore,Ed),r=nS(t),i=_O(t.converter,e);return CO(n,[mO(pO(t.firestore),"addDoc",r._key,i,t.converter!==null,{}).toMutation(r._key,Dr.exists(!1))]).then(()=>r)}function CO(t,e){return function(r,i){const o=new Ir;return r.asyncQueue.enqueueAndForget(async()=>QN(await oO(r),i,o)),o.promise}(my(t),e)}function kO(t,e,n){const r=n.docs.get(e._key),i=new pS(t);return new fS(t,i,e._key,r,new Ua(n.hasPendingWrites,n.fromCache),e.converter)}(function(e,n=!0){(function(i){Qs=i})(pD),wh(new Dl("firestore",(r,{instanceIdentifier:i,options:o})=>{const s=r.getProvider("app").getImmediate(),a=new Ed(new CD(r.getProvider("auth-internal")),new ID(r.getProvider("app-check-internal")),function(c,h){if(!Object.prototype.hasOwnProperty.apply(c.options,["projectId"]))throw new ie($.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new Ml(c.options.projectId,h)}(s,i),s);return o=Object.assign({useFetchStreams:n},o),a._setSettings(o),a},"PUBLIC").setMultipleInstances(!0)),_s(b1,"4.7.3",e),_s(b1,"4.7.3","esm2017")})();var AO="firebase",RO="10.14.0";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
}`);var Ra=Array.from({length:4},function(t,e){return["--OP-annulus-track-phase".concat(e+1,"-color"),"--OP-annulus-sector-phase".concat(e+1,"-color")]}),dc=function(t){return t===void 0&&(t=1),.25*t},oF=function(t){var e,n=cu(t==null?void 0:t.style,t==null?void 0:t.size),r=n.styles,i=n.fontSize,o=t==null?void 0:t.easing,s=uu(t==null?void 0:t.speedPlus,"1s").animationPeriod,a=function(c){var h={},d=Ra.length;if(c instanceof Array){for(var f=du(c,d),g=0;g<f.length&&!(g>=4);g++){var v=Ra[g];try{if(!(x=ee(f[g])).isValid())throw new Error("Invalid Color: ".concat(x.getOriginalInput()));var b=x.setAlpha(dc(x.getAlpha())).toRgbString(),P=f[g];h[v[0]]=b,h[v[1]]=P}catch{P=kr,b=(x=ee(kr)).setAlpha(dc(x.getAlpha())).toRgbString(),h[v[0]]=b,h[v[1]]=P}}return h}try{var x=ee(c);if(typeof c!="string")throw new Error("Color String expected");if(!x.isValid())throw new Error("Invalid Color: ".concat(x.getOriginalInput()));P=c,b=x.setAlpha(dc(x.getAlpha())).toRgbString();for(var w=0;w<d;w++)h[(v=Ra[w])[0]]=b,h[v[1]]=P}catch(_){for(_ instanceof Error?console.warn("[".concat(_.message,']: Received "').concat(typeof c,'" with value, ').concat(JSON.stringify(c))):console.warn("".concat(JSON.stringify(c),' received in <OrbitProgress variant="annulus-track" /> indicator cannot be processed. Using default instead!')),P=kr,b=(x=ee(kr)).setAlpha(dc(x.getAlpha())).toRgbString(),w=0;w<Ra.length;w++)h[(v=Ra[w])[0]]=b,h[v[1]]=P}return h}((e=t==null?void 0:t.color)!==null&&e!==void 0?e:""),l=t.dense?"0.45em":"";return me.createElement("span",{className:"rli-d-i-b OP-annulus-sector-track-rli-bounding-box",style:pe(pe(pe(pe(pe({},i&&{fontSize:i}),s&&{"--rli-animation-duration":s}),o&&{"--rli-animation-function":o}),a),r),role:"status","aria-live":"polite","aria-label":"Loading"},me.createElement("span",{className:"rli-d-i-b OP-annulus-sector-track-indicator"},me.createElement("span",{className:"rli-d-i-b annulus-track-ring",style:pe({},l&&{borderWidth:l})}),me.createElement(hu,{className:"OP-annulus-sector-text",text:t==null?void 0:t.text,textColor:t==null?void 0:t.textColor})))},ZP=function(t){var e=Object(t).variant,n=e===void 0?"disc":e;return n==="dotted"?me.createElement(tF,pe({},t)):n==="spokes"?me.createElement(nF,pe({},t)):n==="disc"?me.createElement(eF,pe({},t)):n==="split-disc"?me.createElement(iF,pe({},t)):n==="track-disc"?me.createElement(oF,pe({},t)):null};wt(`.foursquare-rli-bounding-box {
